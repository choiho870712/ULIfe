    ...
    override fun onCreateView(
        ...
        Thread {
            ...
            if (activity != null) requireActivity().runOnUiThread {
                ...
                GlobalVariables.proposalPageAdapter = CardProposalPageAdapter(
                    GlobalVariables.proposal!!.proposalItemList,
                    root
                )
                GlobalVariables.proposalPageLayoutManager = GridLayoutManager(
                    activity, 1, GridLayoutManager.HORIZONTAL, false
                )
                root.recycler_proposal_page.apply {
                    setHasFixedSize(true)
                    layoutManager = GlobalVariables.proposalPageLayoutManager
                    adapter = GlobalVariables.proposalPageAdapter
                }
