            ...
            if (!isRunningUpdateUserInfo) {
                ...
                if (isSuccess) {
                    ...
                    if (GlobalVariables.userInfo.latitude != 0.0) {
                        activity!!.nav_host_fragment.findNavController().navigate(R.id.action_personEditFragment_to_personShopInfoFragment)
                    }
                    else {
                        activity!!.nav_host_fragment.findNavController().navigate(R.id.action_personEditFragment_to_personInfoFragment)
                    }
                }
                else {
