...
class CardProposalItemAdapter(val myDataset: MutableList<ProposalItem>, val proposalView: View)
    ...
    override fun onBindViewHolder(holder: CardHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener {
            ...
            GlobalVariables.proposalPageLayoutManager.scrollToPosition(
                GlobalVariables.proposalItemIndex)

            proposalView.layout_proposal_page.visibility = View.VISIBLE
            proposalView.layout_proposal_page.animate().alpha(1.0f)
